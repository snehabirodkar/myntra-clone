  ...
  return (
    <>
      <div className="right-details-content">
        <h2 className="productName" style={{ "text-transform": "uppercase", "letterSpacing": "2px", "margin": "5px 0" }}>{props.productName}</h2>
        <p className="productType" style={{ "text-transform": "capitalize", "opacity": "0.4", "fontSize": "24px" }}>{props.productType}</p>
        <hr style={{ "width": "50%", "transform": "translateX(-50%)", marginTop: "25px" }} />
